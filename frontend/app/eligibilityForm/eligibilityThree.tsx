...
<View className="flex-row justify-between mt-6">
  ...
  <TouchableOpacity onPress={()=>router.push('/eligibilityForm/eligibilityThree' as any)} className="bg-primary h-[2px] ml-2" style={{ width:width/10}}/>
...
<View className="w-full px-5 mt-3">
    <Text className="text-lg text-secondary mb-2  ">Have you had any cold, fever, or infection in the past 7 days?</Text>
...
<View className="w-full px-5 mt-5">
    <Text className="text-lg text-secondary mb-2  ">Have you undergone any surgery in the past 6 months?</Text>
<View className="flex-row  space-x-8 mt-3">
    <CheckBox label="Yes" value="yes" selected={surgery} onSelect={setSurgery} />
    <CheckBox label="No" value="no" selected={surgery} onSelect={setSurgery}/>
</View>
</View>

<View className="w-full px-5 mt-5">
    <Text className="text-lg text-secondary mb-2  ">Do you have any known allergies?</Text>
<View className="flex-row  space-x-8 mt-3">
    <CheckBox label="Yes" value="yes" selected={allergies} onSelect={setAllergies} />
    <CheckBox label="No" value="no" selected={allergies} onSelect={setAllergies}/>
</View>
</View>
