...
<View className="flex-row justify-between mt-6">
  ...
  <TouchableOpacity onPress={()=>router.push('/eligibilityForm/eligibilitySeven')} className="bg-primary h-[2px] ml-2 " style={{ width:width/10}}/>
</View>
...
<View className="flex-row  space-x-8 mt-5">
  ...
  <TouchableOpacity
        onPress={() => router.push('/eligibilityForm/eligible')}
